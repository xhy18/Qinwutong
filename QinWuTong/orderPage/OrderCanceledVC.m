...
//  QinWuTong
//
//  Created by ltl on 2019/1/1.
//  Copyright © 2019 ltl. All rights reserved.
//

#import "OrderCanceledVC.h"
#import "OrderCell.h"
#import "OrderObj.h"
#import "skillObj.h"
#import "MJRefresh.h"
...
@implementation OrderCanceledVC
...
-(void)getOrderListByState{
    NSArray *stateList =[NSArray arrayWithObjects:[NSNumber numberWithInt:-10],[NSNumber numberWithInt:-5],nil];
